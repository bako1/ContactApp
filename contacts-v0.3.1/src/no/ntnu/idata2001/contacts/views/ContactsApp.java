...
public class ContactsApp extends Application {
  ...
  // The JavaFX ObservableListWrapper used to connect tot he underlying AddressBookPlain
  ...
  private ObservableList<ContactDetails> getAddressBookListWrapper() {
    ...
    addressBookListWrapper
      = FXCollections.observableArrayList(this.addressBookDBHandler.getAllContacts());
